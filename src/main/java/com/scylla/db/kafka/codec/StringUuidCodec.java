package com.scylla.db.kafka.codec;
...
/**
 * A {@link TypeCodec} that converts from {@link DataType#uuid()} to
 * {@link String}.
 */
public class StringUuidCodec extends TypeCodec<String> {
	...
	public String parse(String value) {
		try {
			...
			throw new InvalidTypeException(String.format("Cannot parse string UUID value from \"%s\"", value), e);
		}
	}
